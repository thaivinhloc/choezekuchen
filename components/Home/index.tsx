                ...
                <div className="container ">
                    <Row>
                        <Col span={24} className="section-title">
                            ...
                            <p>
                                Choeze Kuchen has been dedicating his life in disseminating
                                Dharma across the world.
                            </p>
                        </Col>
                        <Col span={24}>
                            <Row className="section-group">
                                {ABOUT.map(item => (
                                    ...
                                    >
                                        ...
                                        >
                                            <Meta title={item.title} description={<p>{item.subText}</p>} />
                                        </Card>
                                    </Col>
                                ))}
                            </Row>
                ...
                <div className="container ">
                    <Row>
                        <Col span={24} className="section-title">
                            ...
                            <p>
                                Check out our scheduled tour to meet up with devotees. Contact
                                your local centre representative for more information.
                            </p>
                        </Col>
                        <Col span={24}>
                            <Row className="section-group">
                            ...
                            <Row>
                                {CENTRES.map(item => (
                                    <Col xs={24} sm={24} md={12} lg={12} xl={12}>
                                        <Card bordered={false}>
                                            <Meta title={item.name} description={<><p>{item.contact} <br />{item.tel && ("Tel: " + item.tel)}</p></>} />
                                        </Card>
                                    </Col>
                                ))}
                            </Row>
