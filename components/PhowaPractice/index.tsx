...
const CONTENT = [
    ...
    },
    {
        ...
        imgURL:
            "/images/phowa-practice/phowa-01-2.png",
        content: [
    ...
    },
    {
        ...
        imgURL:
            "/images/phowa-practice/Phowa-at-Vinh-Nghiem-Pagoda.jpg",
        content: [
        ...
        <div className="container">
            <div className="pdy-100">
                <BoxContainer
                    ...
                    contentLeft={<Content title={CONTENT[0].title} content={CONTENT[0].content} />}
                />
                <div className="hr" ></div>
                <BoxContainer
                    type="vertical"
                    contentLeft={<Image url={CONTENT[1].imgURL} />}
                    contentRight={<Content title={CONTENT[1].title} content={CONTENT[1].content} />}
                />
                <div className="hr" ></div>
                <BoxContainer
                    type="vertical"
                    contentRight={<Image url={CONTENT[2].imgURL} />}
                    contentLeft={<Content title={CONTENT[2].title} content={CONTENT[2].content} />}
                />
            </div>
