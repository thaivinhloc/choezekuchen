        ...
        <Row className="singaporeCenter-group" align="middle">
          ...
          >
            ...
            <p>
              ...
              ;
              <br /> •
              {t("To afford its members healthy and decent recreations", {
                ns: ["content"],
              })}
              ;
              <br />•
              {t(
                "To work in conjunction with other Buddhist organizations to foster peace, harmony and happiness for all being",
                { ns: ["content"] }
              )}
              .
            </p>
