    ...
    <DivHistory>
      <div className="history">
        <div className="container">
          ...
          <Row className="history-group" align="middle">
            <Col
              className="history-wrapper"
              xs={24}
              sm={24}
          ...
          <Row align="middle">
            ...
            >
              <p style={{ fontWeight: "bold" }}>
                {t("Previous Reincarnation – The 10th Choeze Kuchen Rinpoche", {
                  ns: "content",
                })}
              </p>
              <p>
                {t(
                  "igme Choewang Lodro was born in Kham Dzachukha to father Jampa Zangpo and mother Dolo from Kham. He was recognized as the 10th reincarnation of Choeze Kuchen Rinpoche by the previous H.H. Drikung Kyabgon Chetsang Zhiwi Lodro Rinpoche",
                  { ns: "content" }
                )}
                .
              </p>
              <p>
                {t(
                  "He received many teachings from both Drikung Holinesses and one of his main Guru was Dzogchen master of his time, Dzogchen Khenpo Thubga from Changma Rithro at Dzachukha.",
                  { ns: "content" }
                )}
              </p>
              <p>
                {t(
                  "In the Kham region, he had many followers from different regions and monasteries of Tibet practicing different sects of Buddhism. He is recognized for his profound teachings covering all sects of Buddhism.",
                  { ns: "content" }
                )}
              </p>
            </Col>
          ...
          <Row className="history-group" align="middle">
            ...
            >
              <p>
                {t(
                  "These are golden statues of Yamantaka (central statue) and other deities belonging to the 10th incarnation of Choeze Kuchen Rinpoche",
                  { ns: "content" }
                )}
              </p>
              <p>
                {t(
                  "Yamantaka is an emanation of Lord Manjushri, the Bodhisattva of Wisdom.",
                  { ns: "content" }
                )}
              </p>
              <p></p>
