        ...
        <div className="container">
          ...
          >
            ...
            <p className="mb-0 font-weight-bold">
              {t("", { ns: "content" })}
              Choeze Kuchen Rinpoche is one of the prominent Lamas of Choeze
              Thupten Dhargyeling Monastery located in the eastern part of Tibet
              in Kham under the Yushu, Qinghai Province, China.
            </p>
            <p className="mb-0 font-weight-bold">
              {t("", { ns: "content" })}
