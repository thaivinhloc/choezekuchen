          ...
          <Row className="monastery-group">
            ...
            >
              ...
              <p>
                ...
                <br />• {t("", { ns: "content" })}To train and encourage its
                members to promote Buddhism;
                <br />• {t("", { ns: "content" })}To train and encourage its
                members in acts of charity and general helpfulness to all
                fellow-beings in the fields of social, educational, cultural and
                other humanitarian services;
                <br />• {t("", { ns: "content" })}To afford its members healthy
                and decent recreations; and
                <br />• {t("", { ns: "content" })}
                To work in conjunction with other Buddhist organizations to
                foster peace, harmony and happiness for all beings.
              </p>
            </Col>
            <Col
              xs={24}
