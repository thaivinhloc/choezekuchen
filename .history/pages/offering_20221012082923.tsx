      ...
      <Row className="offering-group mb-5">
        ...
        >
                ...
                <Col xs={24} sm={24} md={24} lg={12} xl={12}>
                  <div className="card text-left">
                    ...
                    <div className="card-body">
                      ...
                      <p className="card-text">
                        {t(
                          "We encourage all to share in the merit of  financially supporting practitioners in Tibet and Nepal chosen by Phakchok Rinpoche to undertake intensive retreats.",
                          {
                            ns: "content",
                          }
                        )}
              ...
              <Row align="middle">
                <Col xs={24} sm={24} md={24} lg={12} xl={12}>
                  <div className="card text-left">
                    ...
                    <div className="card-body">
                      <h4 className="card-title">
                        {t("Offering to Phakchok Rinpoche", {
                          ns: "content",
                        })}
                      </h4>
                      <p className="card-text">
                        {t(
                          "Use this form to make an offering to Phakchok Rinpoche in support of his activities.",
                          {
                            ns: "content",
                          }
                        )}
                ...
                <Col xs={24} sm={24} md={24} lg={12} xl={12}>
                  <div className="card text-left">
                    ...
                    <div className="card-body">
                      <h4 className="card-title">
                        {t(
                          "Offerings for the Daily Lighting of 1,000 Butter Lamps at Asura Cave",
                          {
                            ns: "content",
                          }
                        )}
                      ...
                      <p className="card-text">
                        {t(
                          "Use this form to make offerings for the daily lighting of butter lamps at Asura Cave.",
                          {
                            ns: "content",
                          }
                        )}
          ...
          <div className="updatePayment mt-5">
            ...
            <p>
              {t(
                "To manage your recurring offerings, change your credit card information, and access your donation history, please click the button below.",
                {
                  ns: "content",
                }
              )}
            </p>
            <ButtonStyle className="payment">
              {t("View Offering Dashboard", {
                ns: "content",
              })}
            </ButtonStyle>
          </div>
          <div className="mt-5">
            <h1>
              {t("Offerings to Annual Pujas", {
                ns: "content",
              })}
            </h1>
            <p>
              {t(
                "Each year, our monks at Do-ngak Nyida Zungdrel Sherab Raltri Ling Monastery, located approximately 45 minutes south of Kathmandu, perform pujas and practices on behalf of Phakchok Rinpoche and his students and benefactors. Rinpoche personally selects the pujas after consultation with divinations and the texts of many great masters.",
                {
                  ns: "content",
                }
              )}
            ...
            <p>
              {t(
                "To learn about upcoming pujas, and to make an offering, please click the button below.",
                {
                  ns: "content",
                }
              )}
          ...
          <div className="my-5">
            <h2 style={{ fontWeight: "bold" }}>
              {t("Other Ways to Make an Offering", {
                ns: "content",
              })}
            </h2>
            <h2 style={{ fontWeight: "bold" }}>Check</h2>
            <p>
              {t("To donate by mail, please contact us for more information.", {
                ns: "content",
              })}
            </p>
            <h2 style={{ fontWeight: "bold" }}>
            ...
            <p>
              {t(
                "To arrange a wire transfer, please contact us for more information.",
                {
                  ns: "content",
                }
              )}
            ...
            <h2 style={{ fontWeight: "bold" }}>
              {" "}
              {t("Donor-Advised Fund (DAF)", {
                ns: "content",
              })}
            </h2>
            <p>
              {t(
                "If you currently have a donor-advised charity fund with Fidelity Charitable, we can assist you in directly transferring funds to Samye.",
                {
                  ns: "content",
                }
              )}
            ...
            <h2 style={{ fontWeight: "bold" }}>
              {t("Give While You Shop", {
                ns: "content",
              })}
            </h2>
            <p>
              {t(
                "You can turn every online purchase into a donation to support Samye with Amazon Smile.",
                {
                  ns: "content",
                }
              )}
        ...
        >
          ...
          <ul>
            ...
            <li>
              {t("Support student pathways such as Mahamudra and Ngondro", {
                ns: "content",
              })}
            </li>
            <li>
              {t("Provide both technical and practice support for students", {
                ns: "content",
              })}
            </li>
            <li>
