        ...
        <Row className="singaporeCenter-group" align="middle">
          ...
          >
            ...
            <p>
              ...
              <br /> • To teach its members Buddhism and strict observance of
              its practices;
              <br /> • To train and encourage its members to promote Buddhism;
              <br /> • To train and encourage its members in acts of charity and
              general helpfulness to all fellow-beings in the fields of social,
              educational, cultural and other humanitarian services;
              <br /> • To afford its members healthy and decent recreations; and
          ...
          <Carousel indicators={false}>
            <Carousel.Item>
              <img
                ...
                src="/images/singaporCenter/singapoCenter1.jpg"
                alt="First slide"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                style={{ height: "800px" }}
                className="d-block w-100"
                src="/images/singaporCenter/singapoCenter2.jpg"
                alt="Second slide"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                style={{ height: "800px" }}
                className="d-block w-100"
                src="/images/singaporCenter/singapoCenter3.jpg"
                alt="Third slide"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                style={{ height: "800px" }}
                className="d-block w-100"
                src="/images/singaporCenter/singapoCenter4.jpg"
                alt="Second slide"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                style={{ height: "800px" }}
                className="d-block w-100"
                src="/images/singaporCenter/singapoCenter5.jpg"
                alt="Second slide"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                style={{ height: "800px" }}
                className="d-block w-100"
                src="/images/singaporCenter/singapoCenter6.jpg"
                alt="Second slide"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                style={{ height: "800px" }}
                className="d-block w-100"
                src="/images/singaporCenter/singapoCenter7.jpg"
                alt="Second slide"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                style={{ height: "800px" }}
                className="d-block w-100"
                src="/images/singaporCenter/singapoCenter8.jpg"
                alt="Second slide"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                style={{ height: "800px" }}
                className="d-block w-100"
                src="/images/singaporCenter/singapoCenter9.jpg"
                alt="Second slide"
              />
            </Carousel.Item>
          </Carousel>
