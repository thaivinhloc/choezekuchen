        ...
        <Row className="tibetanMonastery-group" align="middle">
          ...
          >
            <p>
              ...
              <br />
              {t("", { ns: ["content"] })}t project located in Paro – Bhutan,
              one of the first few places visited by Guru Padmasambhava and many
              other Masters, it became one of the Holiest haven for practicing
              Mahayana Tantra Practices that has given birth to many revered
              Yogis and Yoginis. Bhutan is a country where majority of its
              citizens is Buddhist.
            </p>
            <p>
              {t("", { ns: ["content"] })}
