    ...
    <div className="container offering">
      ...
      <Row className="offering-group mb-5">
        ...
        >
          <div>
            <h1>
              {t("", { ns: "content" })}Support the Activities of Samye
              Institute
            </h1>
            <div>
              <p>
              ...
              <Row align="middle">
                ...
                <Col xs={24} sm={24} md={24} lg={12} xl={12}>
                  <div className="card text-left">
                    ...
                    />
                    <div className="card-body">
                      <h4 className="card-title">Retreat Fund</h4>
                      <p className="card-text">
          ...
          <div className="updatePayment mt-5">
            ...
            <button className="payment">View Offering Dashboard</button>
          </div>
          <div className="mt-5">
            <h1>Offerings to Annual Pujas</h1>
            <p>
            ...
            <button className="payment">Puja Schedule and Offerings</button>
          </div>
          <div className="my-5">
            ...
            <p>To donate by mail, please contact us for more information.</p>
            <h2 style={{ fontWeight: "bold" }}>Wire Transfer</h2>
            <p>
            ...
            <h2 style={{ fontWeight: "bold" }}>Give While You Shop</h2>
            <p>
              You can turn every online purchase into a donation to support
              Samye with Amazon Smile.
            </p>
            <h2 style={{ fontWeight: "bold" }}>Volunteer</h2>
            <p>
