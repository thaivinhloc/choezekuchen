...
export default function theBlog() {
  ...
  const listBlog = [
    {
      date: "16 DEC",
      title: "CITY OF GODS AND DEMIGODS",
      postTime: "15:08h ",
      place: "Uncategorized by Choeze Kuchen Rinpoche",
      content:
        "Kathmandu – City of Gods and Demigods. The city of Kathmandu is designed based on the perfect Mandala, the Mandala is the Gods, Nagas, Yakshas and Rakshas...",
    },
    {
      date: "02 MAY",
      title: "VUNG TAU",
