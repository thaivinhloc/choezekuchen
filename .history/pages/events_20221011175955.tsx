      ...
      <div className="container">
        ...
        <Row className="events-group" align="middle">
          ...
          >
            <p>
              {t("", { ns: "content" })}
              Achi Chokyi Drolma<br></br> {t("", { ns: "content" })}The main
              Dharma Protector of Drikung Kagyu Mother Achi was the great
              grandmother of Lord Jigton Sumgon, founder of the Drikung Lineage.
