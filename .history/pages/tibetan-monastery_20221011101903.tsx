      ...
      <div className="container">
        ...
        <Row className="tibetanMonastery-group" align="middle">
          ...
          >
            ...
            <p>
              {t("This is a very important and meaningful project, for the first time in Bhutan, a Retreat Center and Monastery of the Drikung lineage was established.

Bhutan is a pure Vajrayana Buddhist country, home to Guru Rinpoche’s holiest holy sites, where enlightened energy is full. Practicing, retreating, meditating here will bring great benefits to practitioners and all sentient beings", { ns: ["content"] })}
